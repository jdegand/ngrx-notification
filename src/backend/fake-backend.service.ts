import { randSchool } from '../model/school.model';
import { randStudent } from 'src/model/student.model';
import { randTeacher } from 'src/model/teacher.model';
import { inject, Injectable } from '@angular/core';
import { randCompanyName, randFirstName } from '@ngneat/falso';
import { concatLatestFrom } from '@ngrx/effects';
import { map, tap, timer } from 'rxjs';
import { FakeDBService } from '../backend/fake-db.service';
